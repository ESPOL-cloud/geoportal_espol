...
const poligonosStyle1 = new ol.style.Style({
  fill: new ol.style.Fill({
    color: 'rgba(109, 100, 52, 0.6)'    // El 0.5 se refiere a la opacidad
  }),
  stroke: new ol.style.Stroke({ 
    color: '#17191a', 
    width: 2 
